...
convex/http.ts:107:11 - error TS2741: Property 'role' is missing in type '{ details: any; }' but required in type '{ details?: { fullName: string; numberOfProperties: number; } | { fullName: string; currentAddress: string; numberOfPeople: number; currentIncome: number; areaToMove: string; moveDate: string; ... 4 more ...; summary: string; } | { ...; } | undefined; role: string; }'.

107           profile: { details: profile },
              ~~~~~~~

  node_modules/convex/dist/cjs-types/type_utils.d.ts:11:97
